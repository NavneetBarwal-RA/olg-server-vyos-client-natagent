...
| LOG-004 | Covered | `internal/configure/logging_security_test.go` | `TestLoggingDebugWithPayloadFlagLogsPayload` | Explicit configure debug payload flag emits payload through the injected debug path. |
